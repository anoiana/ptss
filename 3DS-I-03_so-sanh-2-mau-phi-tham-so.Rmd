...
```{r fig1, fig.align='center', fig.cap="*Bảng tóm tắt số bệnh nhân tử vong và còn sống tại $t_j$.*"}
d<-
tibble::tibble(
...
draw_table(d,columns = list(
    ` ` = colDef(minWidth = 250),`Tổng cộng`= colDef(minWidth = 150)))
```
