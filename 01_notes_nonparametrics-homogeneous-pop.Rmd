...
plot(x3,y, type = "l", xlab = "Survival time", ylab = "estimated survivor function")
```

This method cannot be used if there exists censors since the information of censors will not be included. Another method that can be used with the presence of censors will now be described below. 
