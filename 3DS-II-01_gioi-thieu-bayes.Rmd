...
::: {.definition #def1 name="Hàm tiên nghiệm liên hợp"}
Cho $L(\theta) = f(x|\theta)$ là hàm hợp lý, $\mathscr{G}$ được gọi là một họ phân bố liên hợp tương ứng với $L(\theta)$ nếu $f(\theta|x) \in \mathscr{G} \Leftrightarrow f(\theta) \in \mathscr{G}, \forall x$. `r proved()`
:::
...
Lựa chọn thứ 2 cho hàm tiên nghiệm là *tiên nghiệm phi chính*. 
